...
AS $$
DECLARE
  project_url TEXT := 'https://byfedkwpoznlllfrlazk.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ5ZmVka3dwb3pubGxsZnJsYXprIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyODM1MTM0MSwiZXhwIjoyMDQzOTI3MzQxfQ.tM51Dqh1NWg3Iff_kgWJ6Jyesa6EryDX1f42sAwMviE'; -- full access needed for http request to storage
